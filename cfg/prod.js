...
// 项目页面路径
let publicPagePath = '//scaffold.weidai.com.cn/';
// 入口页面对象
let publicPageFullname = defaults.getPublicPageFullname(publicPagePath);
// 项目资源路径
let publicAssetPath = `https://static1.weidai.com.cn/static/fed/group/project/${defaults.version}/${defaults.assetDir}/`;
// 后端接口路径
let publicRpcPath = {
  inner: '//scaffold.weidai.com.cn/'
};
